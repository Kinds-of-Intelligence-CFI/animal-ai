...
_If you'd like to use any of the previous versions, please download the corresponding version of the environment from the table above._ The installation instructions for the older versions are the same as the latest version. Please refer to the [installation instructions](#installation) for more details.
