...
### Added
- _New Object: `Hollow-Object`._
  - TA new object to create more complex environments and challenges for the agent. The hollow object is a box that can be configured to have a reward spawn right above it. The reward will be spawned at the same x and z position as the hollow object, so it is easy to configure the reward to spawn directly above the hollow object.
